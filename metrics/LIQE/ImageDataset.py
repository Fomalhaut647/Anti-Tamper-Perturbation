    ...
    def __getitem__(self, index):
        ...
        if not self.test:
            sample = {
                ...
                "mos": float(mos),
                "dist_type": dist_type,
                "dist_sentence": dist_text,
                "scene_content": scene_content,
                "scene_sentence": scene_text,
            }
        else:
            sample = {
                "I": patches,
                ...
                "scene_sentence1": scene_text1,
                "scene_content2": scene_content2,
                "scene_sentence2": scene_text2,
                "scene_content3": scene_content3,
                "scene_sentence3": scene_text3,
                "valid": valid,
            }
...
class ImageDataset_ava(Dataset):
    def __init__(
        self, npy_file, img_dir, preprocess, get_loader=get_default_img_loader
    ):
        """
        Args:
            csv_file (string): Path to the csv file with annotations.
