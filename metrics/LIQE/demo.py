...
logits_per_image1 = logits_per_image1.view(
...
print(
    "Image #1 is a photo of {} with {} artifacts, which has a perceptual quality of {} as quantified by LIQE".format(
        scenes[scene_index1], dists_map[distortion_index1], quality_prediction1.item()
    )
)

logits_per_image2 = logits_per_image2.view(
    -1, len(qualitys), len(scenes), len(dists_map)
)
...
print(
    "Image #2 is a photo of {} with {} artifacts, which has a perceptual quality of {} quantified by LIQE".format(
        scenes[scene_index2], dists_map[distortion_index2], quality_prediction2.item()
    )
)
