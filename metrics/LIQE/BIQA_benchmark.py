...
for session in range(0, 10):
    ...
    ckpt = os.path.join(
        "../CLIP/checkpoints_final/checkpoints",
        str(session + 1),
        "quality_best_ckpt.pt",
    )
    ...
    scene_acc5, dist_acc5, q_mos5, q_hat5 = eval(
        koniq10k_test_loader, "test", "koniq10k"
    )
    scene_acc6, dist_acc6, q_mos6, q_hat6 = eval(
        kadid10k_test_loader, "test", "kadid10k"
    )
