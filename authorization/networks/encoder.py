...
class Encoder(nn.Module):
    ...
    def __init__(self, message_length=30):
        ...
        self.after_concat_layer = ConvBNRelu(
            self.conv_channels + 3 + message_length, self.conv_channels
        )
    ...
    def forward(self, image, message):
        ...
        expanded_message = expanded_message.repeat(1, 1, self.H * self.W).reshape(
            expanded_message.shape[0], -1, self.H, self.W
        )
